...
function Organization() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("http://127.0.0.1:8000/organizations", formData);
                ...
                <div className="row">
                    <div className="card py-3">
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <button className="btn btn-sm btn-primary" onClick={handleAddDistrict}>
                                Add Organization
                            </button>
                        </div>
                    </div>
                                    ...
                                    <form action="" onSubmit={handleSubmit}>
                                        <div className="modal-body">
                                            <div className="form-group my-2 col-md-12">
                                                ...
                                                {errors.org_name && (
                                                    <div className="text-danger small">{errors.org_name}</div>
                                                )}
                                            </div>
